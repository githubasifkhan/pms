...
class CommericalProperty(models.Model):
    ...
    zoning = fields.Integer(string='Zoning', required=True)
    ...
    marketing_heading = fields.Char(string='Marketing Heading', required=True, help="Marketing Head")
    ...
    quick_sell_ref = fields.Integer(string='Quick Sell Reference')
